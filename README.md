...
Fetch and validate one site’s vulnerability disclosure contact file.
...
Open <http://127.0.0.1:8092> in a browser. For CLI-capable tools, run `python3 app.py --help` to see the positional form.
